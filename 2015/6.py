chaine = """turn on 489,959 through 759,964
...
lumieres = [ [0 for x in range( 1000 )] for y in range( 1000 ) ]  
#print(lumieres)
...
def analyse(line):
    ...
    if array[0] == 'toggle': 
        ...
        coord1 = array[2].split(",")
        coord2 = array[4].split(',')
    return [commande,coord1,coord2]

print(analyse('turn on 31,760 through 655,892'))
print(analyse('turn off 820,663 through 832,982'))
print(analyse('toggle 628,958 through 811,992')[1][1])

#print([x for x in range(202, 250)])
for line in chaine.splitlines():
    #print(line)
    instruction = analyse(line)
    #print(instruction)
    if instruction[0] == 0:
